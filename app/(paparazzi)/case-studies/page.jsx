  ...
  return (
    <section className="  py-24">
      <div className="max-w-screen-2xl px-6 mx-auto">
        ...
        <p className="text-start mt-4 text-[#D2940A] mb-4  ">
          {" "}
          {caseData.subHeading}{" "}
        </p>
      </div>

      <div className="bg-white  max-lg:px-12 py-4 max-sm:px-4 ">
        <p className="text-black max-w-screen-2xl px-6 mx-auto  text-lg max-sm:text-base">
          {" "}
          {caseData.paragraph}
        </p>
      </div>
