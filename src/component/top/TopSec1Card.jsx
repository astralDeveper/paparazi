  ...
  return (
    <>
      <div className='max-w-80 max-sm:max-w-screen-lg transition-all w-full h-[380px] relative'>
        <img src={props.image} className='opacity-40 grayscale w-full object-cover h-full' alt="card-img" />

        <div className='bg-white absolute bottom-6 p-4 left-6 right-6'>
            <h5 className='text-[#FF6636] text-center text-lg'>Type of case study</h5>
